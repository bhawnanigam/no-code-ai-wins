...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-background overflow-hidden">
      {/* Modern geometric background for dark theme */}
      <div className="absolute inset-0">
        ...
        <div className="absolute top-0 left-0 w-full h-full">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-conic from-primary/10 via-transparent to-accent/10 rounded-full blur-2xl"></div>
        </div>
        {/* Grid overlay for dark theme */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(255,255,255,0.1)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.1)_1px,transparent_1px)] bg-[size:14px_24px] opacity-20"></div>
      </div>
          ...
          <div className="text-center mb-8">
            <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-card border border-border/50 shadow-lg backdrop-blur-sm mb-6">
              <div className="flex -space-x-1">
                ...
                <div className="w-6 h-6 bg-orange-500 rounded-full border-2 border-card"></div>
                <div className="w-6 h-6 bg-purple-500 rounded-full border-2 border-card"></div>
              </div>
